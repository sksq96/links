    ...
    <div className="px-4 mt-24 pb-40 md:pb-8">
      <div className="mx-auto max-w-5xl">
        <input
          ...
          className="placeholder-gray-600 p-2 border border-gray-400 rounded-md mb-4 bg-[#fff9f9]"
        />
        <button
          onClick={handleShuffleClick}
          className="flex items-center justify-center gap-2 text-gray-600 p-2 border border-gray-400 rounded-md mb-4 float-right bg-[#fff9f9] hover:bg-indigo-100"
        >
          Shuffle
